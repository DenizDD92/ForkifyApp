...
class RecipeView extends ViewClass {
  ...
  _generateMarkUpIngredient(ingrdnt) {
    return `
      ...
      <div class="recipe__quantity">${
        ingrdnt.quantity
          ? new Fraction.Fraction(ingrdnt.quantity).toString()
          : ""
      }</div>
        <div class="recipe__description">
        <span class="recipe__unit">${ingrdnt.unit}</span>
        ${ingrdnt.description}
        </div>
        </li>
        `;
